...
final class ShortenerListCell: UITableViewCell {
  ...
  private func setup() {
    ...
    NSLayoutConstraint.activate([
      cardView.topAnchor.constraint(equalTo: contentView.topAnchor, constant: Theme.Spacing.xl),
      ...
      cardView.bottomAnchor.constraint(equalTo: contentView.bottomAnchor, constant: -Theme.Spacing.xl),
      ...
      shortUrlLabel.topAnchor.constraint(equalTo: aliasLabel.bottomAnchor, constant: Theme.Spacing.xl),
      ...
      copyButton.widthAnchor.constraint(equalToConstant: Theme.Spacing.lg),
      copyButton.heightAnchor.constraint(equalToConstant: Theme.Spacing.lg)
    ])
